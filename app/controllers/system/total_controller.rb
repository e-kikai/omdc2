class System::TotalController < System::ApplicationController
  ...
  def opens
    ...
    when :features
      ...
      deletes   = favorites.unscope("favorites.soft_destroyed_at").where.not("favorites.soft_destroyed_at", nil)
      pdfs      = favorites.unscope("favorites.soft_destroyed_at").where.not("favorites.amount", nil)
